    ...
    public static class Persistence {
        public static void init() {
            try {
                ...
                PreparedStatement statement = cpm.umcs.database.DatabaseConnection.getConnection("connection").prepareStatement(createSQLTable);
        ...
        public static int register(String username, String password) {
            ...
            try {
                ...
                PreparedStatement statement = cpm.umcs.database.DatabaseConnection.getConnection("connection").prepareStatement(insertSQL);
